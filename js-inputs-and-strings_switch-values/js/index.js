...
const buttonSwitch = document.querySelector('[data-js="button-switch"]');
...
buttonSwitch.addEventListener("click", () => {
  ...
  const secondInputText = secondInput.value;
  firstInput.value = secondInputText;
  secondInput.value = firstInputText;
});
